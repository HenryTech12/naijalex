      ...
      <div className="p-5">
        ...
        <div className="mt-4">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-1 p-0.5 bg-brand-bg border border-brand-border rounded-lg w-fit">
              <button
            ...
            <TextToSpeech
              text={activeLanguage === 'english' ? clause.plain_english : clause.pidgin_explanation}
              label={activeLanguage === 'pidgin' ? 'Hear am' : 'Listen'}
              size="sm"
            />
          </div>
